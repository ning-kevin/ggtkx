...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference("Performer.count") do
      post performers_url, params: { performer: { description: @performer.description, email: @performer.email, name: @performer.name, p_times: @performer.p_times, wechat_id: @performer.wechat_id } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { description: @performer.description, email: @performer.email, name: @performer.name, p_times: @performer.p_times, wechat_id: @performer.wechat_id } }
